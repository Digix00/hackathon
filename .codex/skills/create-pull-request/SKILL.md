...
1. リポジトリルートで `bash .codex/skills/create-pull-request/scripts/collect_git_context.sh` を実行し、ブランチ、upstream、status、diff stat、最近のコミットをまとめて確認する。
...
- `bash .codex/skills/create-pull-request/scripts/collect_git_context.sh` を実行する。
