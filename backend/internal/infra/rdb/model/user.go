...
type UserDevice struct {
	ID          string `gorm:"primaryKey"`
	UserID      string `gorm:"not null;index;uniqueIndex:uq_user_devices"`
	Platform    string `gorm:"not null;uniqueIndex:uq_user_devices"` // 'ios' | 'android'
	DeviceID    string `gorm:"not null;uniqueIndex:uq_user_devices"`
